...
export const Certificates = () => {
    return (
        <>
            ...
            <div className='flex items-center flex-col mt-36 mb-4' id='certifications' >
            ...
            <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner">
                    {certificates.map(({ href, description }, index) => (
                        <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                            <img src={href} className=" block m-auto large-desktop:w-1/3 rounded-xl shadow-lg w-3/4" alt={description} />
                        </div>
                    ))}
                </div>

                <button className="carousel-control-prev large-desktop:w-3/5 w-1/5" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
                ...
                <button className="carousel-control-next large-desktop:w-3/5 w-1/5" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
