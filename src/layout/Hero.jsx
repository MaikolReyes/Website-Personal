    ...
    return (
        <div className="heroImage" id='home' key="name">
            ...
            <div className="w-4/5 flex flex-col items-center text-center font-text desktop:w-2/5 animate__animated animate__backInLeft">
                ...
                <p className="text-sm text-white font-title tablet:text-base">Soy un progamador especializado en el <span className='textResalt font-title text-customPrimary'>Desarrollo de Software</span> y <span className='textResalt font-title text-customPrimary'>Análisis de Datos</span>. Cuento con una sólida formación y un conocimiento integral en ambas áreas, lo que me permite abordar desafíos con un enfoque preciso, analítico y orientado a resultados.</p>
