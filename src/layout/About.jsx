    ...
    return (
        <>
            <div className='flex justify-center'>
                <h2 className='title-about text-3xl large-desktop:text-4xl font-semibold font-title tablet:mt-28 tablet:mb-5'>Acerca de mi</h2>
            </div>
            ...
            <div className='flex flex-col items-center mt-20 mb-7 mobile:mt-8'>
                <h2 className="text-3xl large-desktop:text-4xl font-semibold font-title mt-20 mb-4">Stack</h2>
