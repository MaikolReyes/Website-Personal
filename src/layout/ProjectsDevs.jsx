    ...
    return (
        <>
            <div className="portfolio flex flex-col items-center mt-20" id="portfolio" >
                <h2 className="portfolio-title text-3xl large-desktop:text-4xl font-semibold font-title animate__animated animate__backInLeft">Proyectos</h2>

                <p className="portfolio-subtitle w-1/3 m-4 text-base font-title text-center desktop:w-2/5">Te invito a echar un vistazo a mi recorrido en el mundo del desarrollo front-end. Cada proyecto que encontrarás aquí es una pieza clave en mi aprendizaje y evolución. ¡Espero que disfrutes explorando mis creaciones tanto como yo disfruté creándolas!</p>
            </div>

            {
                projects.map(({ name, id, img, description, github, deploy }) => (
                    <div className="container-projects mb-11 flex justify-center text-white animate__animated animate__backInLeft" key={id} >
                        ...
                        <div className="container-images-projects flex items-center bg-customProject h-80 w-1/4 rounded-xl desktop:h-72">
                            <img className="imageProject w-4/5 mx-auto" src={img} alt={name} />
                        </div>

                        <div className="container-text-projects flex flex-col items-center justify-center bg-dark w-1/4 h-80 rounded-xl desktop:w-1/3 desktop:h-72">
