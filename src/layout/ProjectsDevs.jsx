                    ...
                    <div className="mb-11 flex justify-center text-white flex-col desktop:flex-row large-desktop:flex-row items-center animate__animated animate__backInLeft" key={id} >
                        ...
                        <div className="flex flex-col items-center w-4/5 p-3 justify-center bg-dark large-desktop:w-1/4 large-desktop:h-80 rounded-xl desktop:w-1/3 desktop:h-72">
                            ...
                            <div className="mt-3 flex justify-center gap-3">
                                ...
                                <a className="btn text-sm large-desktop:text-base bg-customPrimary font-title font-bold p-2 large-desktop:w-36 hover:text-black hover:bg-customHover" target="_blank" href={deploy}><i className="fa-solid fa-arrow-up-right-from-square p-2"></i>Deploy</a>
                                <a className="btn text-sm large-desktop:text-base bg-customPrimary font-title font-bold p-2 large-desktop:w-36 hover:text-black hover:bg-customHover" target="_blank" href={github} ><i className=" fa-brands fa-github p-2"></i>Github</a>
